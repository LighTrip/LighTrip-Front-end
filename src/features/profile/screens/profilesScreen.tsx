...
import { getMyProfile, logout, withdrawMember } from "@/src/api/profileApi";
...
export default function ProfileView() {
  ...
  return (
    <SafeAreaView edges={["left", "right", "bottom"]} style={styles.container}>
      <View
        style={[styles.fixedHeader, { paddingHorizontal: horizontalPadding }]}
      >
          ...
          <View style={styles.profileLeft}>
            ...
            <View style={styles.profileInfo}>
              <View style={styles.nameRow}>
                <Text
                  style={[styles.userName, isCompact && styles.userNameCompact]}
                  numberOfLines={1}
                  ellipsizeMode="tail"
                >
                  {user.name}
              ...
              >
                <Text style={styles.userStatusItem} numberOfLines={1}>
          ...
          <View style={styles.menuBox}>
            {accountMenuDummy.map((item, index) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
                disabled={item.id === "withdraw" && isWithdrawing}
                onPress={() => {
                  if (item.id === "logout") {
                    handleLogout();
                    return;
              ...
              >
                <View style={styles.menuLeft}>
                  <View
                    style={[
                      styles.iconBox,
                      item.id === "withdraw" && styles.iconBoxDanger,
                    ]}
                  >
                    <Ionicons
                      name={item.icon as any}
                  ...
                  <View style={styles.menuTextBox}>
                    <Text
                      style={[
                        styles.menuTitle,
                        item.id === "withdraw" && styles.menuTitleDanger,
                      ]}
                      numberOfLines={1}
                      ellipsizeMode="tail"
                    >
